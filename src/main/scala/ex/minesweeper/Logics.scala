...
object Logics:
    def apply(pawn: Pair[Int, Int], knight: Pair[Int, Int], size: Int): Logics = LogicsImpl(pawn, knight, size)

    private case class LogicsImpl(override val pawn: Pair[Int, Int], override val knight: Pair[Int, Int], val size: Int) extends Logics:
...
object PiecesGenerator:
    ...
    private case class PiecesGeneratorImpl(size: Int, val pawnPosition: Pair[Int, Int] = Pair(0, 0), val knightPosition: Pair[Int, Int] = Pair(0, 0))
     extends PiecesGenerator:
